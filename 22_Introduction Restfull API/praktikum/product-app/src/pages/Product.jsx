            ...
            <tbody id="table-body">
                { data && data.map((product, index) => (
                    <tr key={index}>
                      ...
                      <td className='border-2 px-2 py-2'>{product.name}</td>
                      <td className='border-2 px-2 py-2'>{product.category}</td>
                      <td className='border-2 px-2 py-2'>{product.quality}</td>
                      <td className='border-2 px-2 py-2'>{product.description}</td>
                      <td className='border-2 px-2 py-2'>{product.price}</td>
