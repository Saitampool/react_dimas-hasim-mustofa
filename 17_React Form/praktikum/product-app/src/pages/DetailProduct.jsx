...
function DetailProduct() {
  ...
  const { productId, productNama, productKategori, productKualitas, productDeskripsi, productRandomNumber, productGambar } = state;
  ...
  return (
    <>
        ...
        <h2 className="mb-4 text-2xl font-semibold">Product Detail: {productNama}</h2>
          ...
          <div >
          <img className='mx-auto mt-2' src={productGambar} alt="Product Image" style={{ width: "300px", height: "auto" }} />
          </div>
