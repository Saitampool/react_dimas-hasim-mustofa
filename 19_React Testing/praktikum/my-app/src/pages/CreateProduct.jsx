...
const CreateProduct = () => {
  ...
  return (
    <>
        ...
        <h2 className="mb-4 text-2xl font-semibold pt-2">Create Product</h2>
        <p>Below is an example form built entirely with Tailwinds form controls. Each required form group has a validation state that can be triggered by attempting to submit the form without completing it.</p>
        <section>
            <form onSubmit={handleSubmit} className='space-y-4 mt-4'>
                <div className='form-group mb-3'>
                    ...
                    />
                    <div className="text-red-500" style={{ display: namaBoolean === true ? (nama.length < 6 || /[@#{}[]]/.test(nama) ? "block" : "none") : "none" }}>
                        {nama.length < 6 ? "Product Name minimum 6 characters!" : "Product Name contains invalid characters!"}
                    </div>
                    <div className="text-red-500" style={{  display: nama.length > 25 ? "block" : "none" }}> 
